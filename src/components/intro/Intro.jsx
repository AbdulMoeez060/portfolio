        ...
        <div className="intro">
            <div className="i-left">
                <div className="i-left-wrapper">
                    ...
                    <p className="i-desc">
                        I love to work on challenging Software projects that give me chance to learn on the runtime and gain experience. I absoulutely love a great read and most of all i like to sleep as if it's my last time.
                    </p>
                </div>
                <svg
                    width="75"
            ...
            <div className="i-right">
                ...
                <img src={sample} alt="" className="i-image" />
            </div>
        </div>
    )
}
